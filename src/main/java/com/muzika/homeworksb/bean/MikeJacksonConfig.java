...
public class MikeJacksonConfig {
    ...
    public ObjectMapper objectMapper() {
        ...
        // To fixorg.springframework.http.converter.HttpMessageConversionException: Type definition error: [simple type,
        // class java.time.LocalDateTime]] with root cause
